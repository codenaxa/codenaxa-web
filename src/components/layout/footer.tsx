        ...
        <Grid container spacing={{ xs: 6, md: 10 }} sx={{ mb: 8 }}>
          <Grid size={{ xs: 12, md: 4.5 }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 420, lineHeight: 1.8, mb: 5 }}>
              Codenaxa builds custom booking systems, restaurant menu websites, and clinic appointment scheduling for small businesses in Kerala and India. Professional web solutions starting at ₹8,000.
            </Typography>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 2.5 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              {[
                { label: "Best Developer Kerala", href: "/best-freelance-web-developer-kerala" },
                { label: "Website Cost Kerala", href: "/website-cost-kerala" },
                { label: "Hire Web Developer Guide", href: "/hire-web-developer-kerala-guide" },
              ].map((item) => (
